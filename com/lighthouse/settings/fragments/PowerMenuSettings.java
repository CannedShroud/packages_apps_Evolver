...
public class PowerMenuSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.lighthouse_settings_power_menu);
        ...
        if (!LighthouseUtils.deviceHasFlashlight(getActivity())) {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.lighthouse_settings_power_menu);
}
